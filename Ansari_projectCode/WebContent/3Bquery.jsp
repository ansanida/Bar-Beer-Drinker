...
<body>
	...
	try {
		...
		String str1 = "select drinker, sum(quantity) as beer_count from bills left join transactions on bills.bill_id = transactions.bill_id where item = \"" + newBeer + "\" group by bar order by beer_count desc";
