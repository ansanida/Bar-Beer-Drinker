...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String newDrinker = request.getParameter("drink");
   		//String graphType = request.getParameter("graph");   
   		//Make a query
   		String query = "select date_format(time, '%H') as hourtime, count(bills.bill_id) as bill_count from bills join transactions on bills.bill_id = transactions.bill_id where item = \"" + newDrinker + "\" group by hourtime order by hourtime";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("hourtime"),result.getInt("bill_count"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        //Create the chart title according to what the user selected
          ...
          chartTitle = "When this Beer Sells the Most";
          legend = "beers";
