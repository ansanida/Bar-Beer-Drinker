...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "select drinker, item, sum(quantity) as quantity_count from bills left join transactions on bills.bill_id = transactions.bill_id where drinker = \"" + newDrinker + "\" and type = \"beer\" group by item order by quantity_count desc";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("item"),result.getInt("quantity_count"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        //Create the chart title according to what the user selected
          ...
          chartTitle = "Beers That Drinker Orders The Most";
          legend = "beers";
